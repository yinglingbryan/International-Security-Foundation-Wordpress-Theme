...
include_once (get_stylesheet_directory()."/builder/includes/hero-banners-functions.php");
...
if ($arrayOfIDS == "") $numberOfBanners = 0;
...
while ($i < $numberOfBanners) {
	...
	include (get_stylesheet_directory()."/builder/includes/hero-banners-single.php");
