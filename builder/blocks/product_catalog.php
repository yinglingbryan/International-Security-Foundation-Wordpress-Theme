...
$builder_vars['needs_wrapper'] = 0;
	...
	<section class="product-catalog"><!-- section //-->
		<div class="pb-container grid"><!-- grid container //-->
			...
			<div class="grid-item"> <!-- single product grid content  : start //-->
			<div class="content">

				<div class="inner-content pb-product ">			
					<div class="behind-product"></div>

								<div class="product-contents">
								<div class="product-header">
									<h3 class="align-center product-title">
										<?php echo $showproduct['title']; ?>
									</h3>
									<h4 class="align-center product-price">
										<?php echo $showproduct['price']; ?> USD
									</h4>
								</div>
								<div class="product-body xs-text">
				...
				</div> <!-- single product grid content : end //-->
