...
$builder_vars['needs_wrapper'] = 0;
	...
	<?php			
				...
				// configurable_price_product :: start
							...
							$shopping_cart_options = get_sub_field("shopping_cart_options");
							//var_dump($shopping_cart_options);


							$showproduct = array();
							$showproduct['title'] = get_sub_field( 'title' );



							$showproduct['button_text'] = $shopping_cart_options['add_to_cart_button_text'];
							$showproduct['image'] = $shopping_cart_options['shopping_cart_thumbnail'];
							$showproduct['enable_note'] = $shopping_cart_options['enable_customer_note'];
							$showproduct['note_instructions'] = $shopping_cart_options['customer_note_instructions'];
...
<section class="cp-product">
	<div class="pb-container">
		<div class="content">
				
		<div class="align-center cp-product">
